...
- Package: sdk-workflow (located in `C:\Users\Ray\.claude\sdk-workflow`)
...
**CLI Additions:**
```bash
sdk-workflow run --profile --trace-output traces.json
sdk-workflow benchmark --operations 1000
sdk-workflow monitor --realtime
```
**Test Files:**
...
- <key metrics>
- <performance impact>
Co-authored-by: Implementer Agent <implementer@sdk-workflow>
Co-authored-by: Reviewer Agent <reviewer@sdk-workflow>
Co-authored-by: Tester Agent <tester@sdk-workflow>
```
...
├── .github/
│   ├── workflows/
│   │   ├── security-scan.yml        [NEW - Phase 4]
│   │   └── tests.yml                [NEW - Phase 4]
│   └── dependabot.yml               [NEW - Phase 4]
├── .pre-commit-config.yaml          [NEW - Phase 4]
├── sdk_workflow/
│   ├── core/
│   │   ├── agent_client.py          [MODIFIED - Phase 3]
│   │   ├── cache.py                 [EXISTING]
│   │   ├── cache_manager.py         [NEW - Phase 3]
│   │   ├── lru_cache.py             [NEW - Phase 3]
│   │   ├── semantic_cache.py        [NEW - Phase 3]
│   │   ├── metrics.py               [ENHANCED - Phase 5]
│   │   ├── performance.py           [NEW - Phase 5]
│   │   ├── profiling.py             [NEW - Phase 5]
│   │   └── logging.py               [NEW - Phase 5]
│   ├── managers/
│   │   ├── token_manager.py         [ENHANCED - Phase 1]
│   │   ├── cost_manager.py          [ENHANCED - Phase 1]
│   │   ├── checkpoint_manager.py    [ENHANCED - Phase 1]
│   │   └── session_manager.py       [ENHANCED - Phase 1]
│   ├── cli/
│   │   ├── main.py                  [REFACTORED - Phase 2]
│   │   └── arguments.py             [REFACTORED - Phase 2]
│   └── executors/
│       └── streaming_example.py     [REFACTORED - Phase 2]
├── tests/
│   ├── test_token_manager.py        [NEW - Phase 1]
│   ├── test_cost_manager.py         [NEW - Phase 1]
│   ├── test_checkpoint_manager.py   [NEW - Phase 1]
│   ├── test_session_manager.py      [NEW - Phase 1]
│   ├── test_lru_cache.py            [NEW - Phase 3]
│   ├── test_semantic_cache.py       [NEW - Phase 3]
│   ├── test_cache_manager.py        [NEW - Phase 3]
│   ├── test_cache_integration.py    [NEW - Phase 3]
│   ├── test_performance.py          [NEW - Phase 5]
│   ├── test_profiling.py            [NEW - Phase 5]
│   └── test_logging.py              [NEW - Phase 5]
├── benchmarks/                      [NEW - Phase 5]
│   ├── benchmark_managers.py
│   ├── benchmark_executors.py
│   └── benchmark_cache.py
├── pyproject.toml                   [MODIFIED - Phase 4]
├── requirements-lock.txt            [NEW - Phase 4]
├── requirements-dev.txt             [NEW - Phase 4]
├── SECURITY.md                      [NEW - Phase 4]
└── SDK_OPTIMIZATION_PLAN.md         [THIS FILE]
```
**Total New Files:** ~25
