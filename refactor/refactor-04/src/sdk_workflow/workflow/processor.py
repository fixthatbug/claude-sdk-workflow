"""Workflow Processor - Workflow integration and batch processing."""
...
class WorkflowModeIntegrator:
    ...
    async def _run_step(self, step: WorkflowStep, context: Dict, dep_results: Dict) -> Any:
        last_error = None
...
class BatchProcessor:
    ...
    async def process(self, items: List[Any], processor: Callable[[Any], Any]) -> List[BatchItem]:
        results = []
        total = len(items)
        completed = 0
